                    ...
                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="text-align: left;"
                        ...
                        <tr>
                            <td>
                                ...
                                <p style="font-size: 14px;">Vous aviez recu un nouveau rapport concernant votre denonciation</p>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table class="order-detail" border="0" cellpadding="0" cellspacing="0" align="left"
                        ...
                        <tr>
                            <td valign="top" style="padding-left: 15px; ">
                                <h5 style="margin-top: 15px; text-align: center;"> {{ App\Models\Rapport::getDenunciationRapports($rapports->denunciation_id  ) }} </h5>
                            </td>
                            <td valign="top" style="padding-left: 15px;">
                                <h5 style="margin-top: 15px; text-align: center;">{{$rapports->title}} </h5>
                            </td>
                            <td valign="top" style="padding-left: 15px;">
                                <h5 style="margin-top: 15px; text-align: center;">{{$rapports->content}} </h5>
                            </td>
